...
#else
  #define CASADI_PREFIX(ID) car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_ ## ID
#endif
...
/* car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess:(i0[60],i1[],i2[48],i3[],i4[])->(o0[48],o1[60x48,171nz],o2[60x60,135nz],o3[48x0],o4[]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a3=6.2746131716582521e-01;
  a4=arg[0]? arg[0][1] : 0;
  a5=(a3*a4);
  a0=(a0+a5);
  a5=3.9370770453947229e-01;
  a6=arg[0]? arg[0][2] : 0;
  a7=(a5*a6);
  a0=(a0+a7);
  a7=2.4703635486867082e-01;
  a8=arg[0]? arg[0][3] : 0;
  a9=(a7*a8);
  a0=(a0+a9);
  ...
  a41=1.2549226343316504e+00;
  a49=(a41*a6);
  a49=(a4+a49);
  a50=1.1811231136184168e+00;
  a51=(a50*a8);
  a49=(a49+a51);
  a49=(a49-a15);
...
CASADI_SYMBOL_EXPORT int car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_release(int mem) {
}

CASADI_SYMBOL_EXPORT void car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_incref(void) {
}

CASADI_SYMBOL_EXPORT void car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_n_in(void) { return 5;}

CASADI_SYMBOL_EXPORT casadi_int car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_n_out(void) { return 5;}

CASADI_SYMBOL_EXPORT casadi_real car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    case 2: return "o2";
...
CASADI_SYMBOL_EXPORT const casadi_int* car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int car1_Arcsolver_0_constr_h_fun_jac_uxt_zt_hess_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 5;
  if (sz_res) *sz_res = 5;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
